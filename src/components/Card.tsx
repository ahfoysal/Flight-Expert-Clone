    ...
    <div className="border border-gray-400/10 rounded-md bg-white shadow-md shadow-gray-400/20 p-5">
      <section className="flex gap-10 justify-between flex-wrap">
        ...
        <div className="flex items-center justify-center flex-col">
          ...
          <img src="non-stop-shape.webp" className="my-4" />
        ...
        <div className="">
          <button className="btn font-semibold bg-red-600 text-white px-6 py-3 rounded-md text-md hover:bg-red-700">
            {" "}
            Book Now
          </button>
        </div>
      ...
      <div className="flex justify-between gap-2 mt-5 xl:mt-0 items-center">
        ...
        <span className="text-red-500 font-semibold text-lg flex items-center gap-3">
          {" "}
          Flight Details <IoIosArrowDown size={21} />
        </span>
      </div>
    </div>
  );
